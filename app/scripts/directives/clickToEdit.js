// var textEditString =
//     '<input class="inputText" type="text" ng-model="localModel" ng-enter="save()" ng-show="editState && type == \'inputText\'" ng-change="save()/>';
//
// var dateEditString =
//     '<input class="inputText" type="datetime-local" ng-model="localModel" ng-enter="save()" ng-show="editState && type == \'datetime-local\'" ng-change="save()/>';
//
// var timeEditString =
//     '<input class="inputText" type="time" ng-model="localModel" ng-enter="save()" ng-show="editState && type == \'time\'" ng-change="save()/>';
//
// var numberEditString =
//     '<input class="inputText" type="number" ng-model="localModel" ng-enter="save()" ng-show="editState && type == \'number\'" ng-change="save()/>';
//
